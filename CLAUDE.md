...
### Plataforma
- [ ] Login/senha (1 usuário admin, sem RBAC multi-nível ainda) — implementado (`internal/auth`, sessão em `admin_sessions`, ver seção "Leva 2" abaixo), falta verificar ponta a ponta num droplet real antes de riscar
